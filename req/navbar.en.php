		...
		<div class="container">
				...
				<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
						<ul class="nav navbar-nav">
								<li<?php echo $page=='index'?' class="active"':'';?>><a href="?page=index">Home</a></li>


			<li<?php echo $page=='index2'?' class="active"':'';?>>
									<a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void();">About Us<span class="caret"></span></a>
