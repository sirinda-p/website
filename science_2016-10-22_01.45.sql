...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2016 at 01:45 AM
...
(3, 'อาจารย์', 'ศรันยา', 'มะระพฤกษ์วรรณ', '-', 1, '-'),
(4, 'ผู้ช่วยศาสตราจารย์', 'อรรถวิท', 'กปิลกาญจน์', '', 1, ''),
(5, 'อาจารย์ ดร.', 'จักรินทร์', 'สิงห์หนู', '', 1, ''),
(6, 'ผู้ช่วยศาสตราจารย์', 'เกศศิริ', 'เหล่าวชิระสุวรรณ', '', 11, ''),
(7, 'อาจารย์', 'เฉลิมพงค์', 'คำวงค์ษา', '', 11, ''),
(8, 'ผู้ช่วยศาสตราจารย์ ดร.', 'เหมือนหมาย', 'อภินทนาพงศ์', '', 11, ''),
(9, 'อาจารย์', 'จตุภัทร', 'ขจัดภัย', '', 11, ''),
(10, 'ผู้ช่วยศาสตราจารย์', 'ทวีศักดิ์', 'พงษ์ปัญญา', '', 11, ''),
(11, 'อาจารย์', 'ทิวา', 'เพ็ญสุข', '', 11, ''),
(12, 'อาจารย์', 'ธนวรรษ์', 'เสริมพาณิชย์', '', 11, ''),
(13, 'อาจารย์', 'ธีรวุฒิ', 'หวังอำนวยพร', '', 11, ''),
(14, 'อาจารย์', 'นิศานาถ', 'ขันธวิสูตร', '', 11, ''),
(15, 'ผู้ช่วยศาสตราจารย์', 'บุญหญิง', 'สมร่าง', '', 11, ''),
(16, 'อาจารย์', 'ประยง', 'มหากิตติคุณ', '', 11, ''),
(17, 'อาจารย์', 'ปัทมพร', 'ราชภักดี', '', 11, ''),
(18, 'ผู้ช่วยศาสตราจารย์', 'พรชัย', 'เหลืองบริสุทธิ์', '', 11, ''),
(19, 'ผู้ช่วยศาสตราจารย์ ดร.', 'พิชญอร', 'ไหมสุทธิสกุล', '', 11, ''),
(20, 'ผู้ช่วยศาสตราจารย์', 'ภัชรี', 'สิทธิกิจโยธิน', '', 11, ''),
(21, 'ผู้ช่วยศาสตราจารย์', 'ลักขณา', 'เศาธยะนันท์', '', 11, ''),
(22, 'อาจารย์', 'วิรัช', 'ตฤณขจี', '', 11, ''),
(23, 'อาจารย์ ดร.', 'อิทธิพงษ์', 'เขมะเพชร', '', 11, ''),
(24, 'อาจารย์ ดร.', 'วัศวี', 'แสนศรีมหาชัย', '', 11, ''),
(25, 'อาจารย์', 'สุนันทา', 'คชสาร', '', 11, ''),
(26, 'อาจารย์', 'สุวโรจน์', 'อัครวุฒิพรภัทร์', '', 11, '');
...
--
ALTER TABLE `instructor`
  MODIFY `instructorID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=27;
--
